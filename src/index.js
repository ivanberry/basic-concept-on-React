...
import UnContorlledEmailInput from './DerivedState/EmailInput/fullUnControl';
...
const Index = () => (
	<div style={{ height: '100%' }}>
		<ul>
			...
			<li><Link to="/code-reuse">代码复用</Link></li>
			{/* <li>
		...
		<Route path="/full-uncontrol-input" component={() => <UnContorlledEmailInput user={fakerUser} />} />
	</div>
);
